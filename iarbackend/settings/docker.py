...
# Debug-related functionality is only enabled if the IAR_ENABLE_DEBUG_THIS_IS_DANGEROUS environment
# variable is set and is non-empty.
DEBUG = os.environ.get('IAR_ENABLE_DEBUG_THIS_IS_DANGEROUS', '') != ''
